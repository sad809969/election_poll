...
from app.core.config import settings  # Your database URL setting
...
def run_migrations_offline() -> None:
    ...
    # Pull dynamically from settings if available, else fall back to alembic.ini
...
def run_migrations_online() -> None:
    ...
    # Dynamically inject database connection settings
